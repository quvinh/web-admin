...
@section('title')
Admin | Lịch và sự kiện
@endsection

@section('css')
    <!-- third party css -->
    <link href="{{ asset('admins/css/vendor/fullcalendar.min.css') }}" rel="stylesheet" type="text/css">
    <!-- third party css end -->
    <!-- App css -->
...
@section('script')
    ...
    <!-- third party js -->
    <script src="{{ asset('admins/js/vendor/fullcalendar.min.js') }}"></script>
    <!-- third party js ends -->

    <!-- demo app -->
    <script src="{{ asset('admins/js/pages/demo.calendar.js') }}"></script>
    <!-- end demo js-->
@endsection
